    ...
    <div class="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl shadow-2xl">
        ...
        <form action="/register" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="full_name" class="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500 transition-colors">
            </div>
            <div>
            ...
            <div>
                ...
                <input type="email" name="email" required class="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500 transition-colors">
            </div>
            <div>
