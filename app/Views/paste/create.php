    ...
    <form action="<?php echo $base; ?>/paste/new" method="POST" class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row gap-4 items-end">
            <div class="flex-grow w-full">
                ...
                <input type="text" name="p_title" id="p_title" autocomplete="off" value="<?php echo isset($clone) ? htmlspecialchars($clone['title']) . ' (Clone)' : ''; ?>" placeholder="Untitled Paste" class="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:border-indigo-500 transition-all text-lg font-bold">
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-zinc-50 dark:bg-zinc-900/50 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-800">
            <div>
                <label class="block text-sm font-medium text-zinc-500 mb-2">Expiration</label>
                <select name="expiration" class="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500 transition-all text-sm">
            ...
            <div>
                ...
                <input type="password" name="password" placeholder="Leave empty for none" class="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-xl px-4 py-2 focus:outline-none focus:border-indigo-500 transition-all text-sm">
            </div>
        </div>
