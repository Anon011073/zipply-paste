...
<div class="max-w-md mx-auto py-24">
    <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-3xl shadow-2xl text-center">
        ...
        <h1 class="text-2xl font-bold mb-2 text-zinc-900 dark:text-white">Password Protected</h1>
        ...
        <form action="<?php echo $base; ?>/v/<?php echo $slug; ?>/unlock" method="POST" class="space-y-4">
            ...
            <input type="password" name="password" required placeholder="Enter password..." class="w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:border-indigo-500 transition-all">
