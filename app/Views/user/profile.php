        ...
        <div class="px-8 pb-8 -mt-12">
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div class="flex items-end gap-6">
                    <div class="w-32 h-32 bg-zinc-800 rounded-2xl border-4 border-zinc-900 shadow-xl flex items-center justify-center overflow-hidden">
                        <?php if ($user['avatar']): ?>
                            <img src="<?php echo \App\Helpers\View::e($user['avatar']); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <?php else: ?>
                            <?php foreach ($pastes as $p): ?>
                                <a href="<?php echo $base; ?>/v/<?php echo $p['slug']; ?>" class="block bg-zinc-950 border border-zinc-800 hover:border-indigo-500/50 p-4 rounded-2xl transition-all group">
